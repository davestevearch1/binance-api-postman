...
Automatically scans all USDT perpetual futures pairs and alerts you on Telegram when a coin is at an obvious short/retrace point — so you don't have to click through every chart manually.
...
You'll see live logs in the terminal. Alerts go to your Telegram.
...
The scanner only reads public market data — no API key needed. It does **not** place any trades.
...
24h Change: +28.14% (pump in progress)
